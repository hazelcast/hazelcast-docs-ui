...
//     },
//     patterns: [
//       'https://docs.hazelcast.com/hazelcast/5.5/maintain-cluster/rest-api-swagger',
//     ],
//   },
//   actions: [
//     {
...
//         };
//         const records = [];
//         // should find also all h2 elements etc.
//         $("div[data-section-id] p").each((_i, paragraph) => {
//           const text = $(paragraph).text().trim();
//
//           records.push(
//             {
//               type: RECORD_TYPE.OPENAPI,
//               url: url,
//               content: text,
//             }
//           );
