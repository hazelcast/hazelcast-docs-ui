...
++++
<div class="card">
	<h3 class="card-header cloud"><img src="cloud.svg">
		 hazelcast
	</h3>
	...
	<ul>
		<li class="get-started-home">
			<a href="https://docs.cloud.hazelcast.com/docs/getting-started">Get Started <img src="right-arrow.svg"></a>
		</li>
	</ul>
++++

++++
	<h3 class="card-header imdg"><img src="imdg.svg">
		 hazelcast
	</h3>
	<p class="card-summary">
	...
	<ul>
		...
		<li class="get-started-home">
			<a href="https://jakescahill.github.io/hazelcast-docs/imdg/latest/getting-started.html">Get Started <img src="right-arrow.svg"></a>
		</li>
	</ul>
...
++++
	<h3 class="card-header jet"><img src="jet.svg">
		 hazelcast
	</h3>
	<p class="card-summary">
	...
	<ul>
		...
		<li class="get-started-home">
			<a href="https://jet-start.sh/docs/get-started/intro">Get Started <img src="right-arrow.svg"></a>
		</li>
	</ul>
</div>
++++
...
<div class="card">
	...
	<ul>
		<li class="get-started-home">
			<a href="https://docs.hazelcast.org/docs/management-center/latest/manual/html/index.html#deploying-and-starting">Get Started <img src="right-arrow.svg"></a>
		</li>
	</ul>
++++
